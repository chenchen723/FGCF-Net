...
def train(train_loader, model,  optimizer, epoch,  opt):
    ...
    if epoch == opt.epochs:
        ckpt_path = os.path.join(opt.save_path, 'Model3.pth')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_root', default='./dataset', type=str, help='data path')
    ...
    parser.add_argument('--test_path1', type=str, default='./dataset/TestDataset/CVC-ClinicDB', help='path to test dataset')
    parser.add_argument('--test_path2', type=str, default='./dataset/TestDataset/Kvasir', help='path to test dataset')
    parser.add_argument('--test_path3', type=str, default='./dataset/TestDataset/CVC-ColonDB', help='path to test dataset')
    parser.add_argument('--test_path4', type=str, default='./dataset/TestDataset/ETIS-LaribPolypDB', help='path to test dataset')
    parser.add_argument('--test_path5', type=str, default='./dataset/TestDataset/CVC-300', help='path to test dataset')
    ...
    parser.add_argument('--decay_epoch', default=1, type=int, help='decay eopoch of learning rate')
